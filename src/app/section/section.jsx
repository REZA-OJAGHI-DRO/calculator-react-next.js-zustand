...
function Ar1() {
  ...
  return (
    <article className="w-[100%] h-[20%] md:h-[25%] flex justify-center px-2 items-center border-b-[2px] border-[rgba(147,146,146,0.34)]">
      <div className="w-[100%] lg:w-[70%] h-[70%] bg-[rgba(0,0,0,0.45)] rounded-xl flex-wrap shadow-black shadow-lg text-[3rem] px-4 flex items-center">
        <p className='w-[100%] h-[30%] text-[1rem] px-4 flex items-center'>
            {p1}{p2}
        </p>
        <p className='w-[100%] h-[70%]  text-[3rem] px-4 flex items-center'>
        {x}
        </p>
        </div>
    </article>
